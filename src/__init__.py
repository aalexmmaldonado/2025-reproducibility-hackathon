...
def enable_logging(
    ...
    logger.enable("reprohack")


if literal_eval(os.environ.get("reprohack_LOG", "False")):
    level = int(os.environ.get("reprohack_LOG_LEVEL", 20))
    stdout = literal_eval(os.environ.get("reprohack_STDOUT", "True"))
    log_file_path = os.environ.get("reprohack_LOG_FILE_PATH", None)
